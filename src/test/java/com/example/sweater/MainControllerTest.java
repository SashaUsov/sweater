...
public class MainControllerTest {
    ...
    public void mainPageTest() throws Exception {
        this.mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath("//div[@id='navbarSupportedContent']/div").string("wow"));
    }
    ...
    public void filterMessageTest() throws Exception {
        this.mockMvc.perform(get("/main").param("filter", "my"))
                .andDo(print())
                .andExpect(authenticated())
    ...
    @Test
    public void addMessageYoList() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]/div/i").string("#new"));
    }
}
